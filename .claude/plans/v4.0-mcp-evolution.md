...
1. Create `mcp/src/telemetry.ts` exporting:
   ...
   - Endpoint constant at top of file: `const TELEMETRY_ENDPOINT = "https://sceneview-telemetry.mcp-tools-lab.workers.dev/v1/events"` — deployed and live.
...
3. ✅ Telemetry Worker deployed at `sceneview-telemetry.mcp-tools-lab.workers.dev`
