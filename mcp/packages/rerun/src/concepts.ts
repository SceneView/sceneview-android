...
export const RERUN_CONCEPTS: RerunConcept[] = [
  "rrd",
  "timelines",
  "entities",
  "archetypes",
...
const EXPLANATIONS: Record<RerunConcept, string> = {
...
export function explainConcept(concept: RerunConcept): string {
