...
export const FURNITURE_MODEL_CATEGORIES = [
...
export function listFurnitureModels(category, tag) {
...
export function getFurnitureModel(id) {
    return FURNITURE_MODELS[id];
}
export function formatFurnitureModelList(models) {
    if (models.length === 0) {
