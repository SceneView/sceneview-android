export const SAMPLES = {
    "model-viewer": {
        ...
        prompt: "Create an Android Compose screen called `ModelViewerScreen` that loads a GLB file from assets/models/my_model.glb and displays it in a full-screen 3D scene with an orbit camera (drag to rotate, pinch to zoom). Add an HDR environment from assets/environments/sky_2k.hdr for realistic lighting. Use SceneView `io.github.sceneview:sceneview:3.3.0`.",
        code: `@Composable
fun ModelViewerScreen() {
    ...
    "geometry-scene": {
        ...
        dependency: "io.github.sceneview:sceneview:3.3.0",
        prompt: "Create an Android Compose screen called `GeometrySceneScreen` that renders a full-screen 3D scene with a red rotating cube, a metallic blue sphere, and a green floor plane. No model files — use SceneView built-in geometry nodes. Orbit camera. Use SceneView `io.github.sceneview:sceneview:3.3.0`.",
        code: `@Composable
