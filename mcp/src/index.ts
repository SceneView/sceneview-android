...
const server = new Server(
  { name: "sceneview-mcp", version: "3.5.4" },
  ...
  resources: [
    {
      ...
      description:
        "Complete SceneView 3.5.2 API — Scene, ARScene, SceneScope DSL, ARSceneScope DSL, node types, resource loading, camera, gestures, math types, threading rules, and common patterns. Read this before writing any SceneView code.",
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  switch (request.params.name) {
    ...
    case "get_sample": {
      ...
      const depBlock = isIos
        ? [
            `**SPM dependency:**`,
            `\`\`\`swift`,
            `.package(url: "${sample.spmDependency ?? sample.dependency}", from: "3.5.2")`,
            `\`\`\``,
          ]
        : [
            `**Gradle dependency:**`,
    ...
    case "list_platforms": {
      const platforms = [
        { platform: "Android", renderer: "Filament", framework: "Jetpack Compose", status: "Stable", version: "3.5.2", dependency: "io.github.sceneview:sceneview:3.5.2", features: ["3D", "AR (ARCore)", "Model loading (GLB/glTF)", "Geometry nodes", "Physics", "Gestures"] },
        { platform: "Android TV", renderer: "Filament", framework: "Compose TV", status: "Alpha", version: "3.5.2", dependency: "io.github.sceneview:sceneview:3.5.2", features: ["3D", "D-pad controls", "Auto-rotation", "Model loading"] },
        ...
        { platform: "iOS", renderer: "RealityKit", framework: "SwiftUI", status: "Alpha", version: "3.5.2", dependency: "SceneViewSwift (SPM)", features: ["3D", "AR (ARKit)", "16 node types", "USDZ models"] },
        { platform: "macOS", renderer: "RealityKit", framework: "SwiftUI", status: "Alpha", version: "3.5.2", dependency: "SceneViewSwift (SPM)", features: ["3D", "Orbit camera", "USDZ models"] },
        { platform: "visionOS", renderer: "RealityKit", framework: "SwiftUI", status: "Alpha", version: "3.5.2", dependency: "SceneViewSwift (SPM)", features: ["3D", "Immersive spaces", "Hand tracking (planned)"] },
        { platform: "Web", renderer: "Filament.js (WASM)", framework: "Kotlin/JS", status: "Alpha", version: "3.5.2", dependency: "@sceneview/sceneview-web", features: ["3D", "WebXR AR/VR", "GLB models", "WebGL2"] },
        { platform: "Desktop", renderer: "Software / Filament JNI", framework: "Compose Desktop", status: "Alpha", version: "3.5.2", dependency: "sceneview-desktop (local)", features: ["3D", "Software renderer", "Wireframe"] },
        { platform: "Flutter", renderer: "Filament / RealityKit", framework: "PlatformView", status: "Alpha", version: "3.5.2", dependency: "flutter pub: sceneview", features: ["3D", "AR", "Android + iOS bridge"] },
      ];
