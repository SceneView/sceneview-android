...
export interface EnvironmentCodeResult {
  code: string;
...
const ANDROID_ENVIRONMENTS: Record<EnvironmentType, { code: string; description: string; notes: string[] }> = {
  "hdr-environment": {
...
const IOS_ENVIRONMENTS: Record<string, { code: string; description: string; notes: string[] }> = {
  "hdr-environment": {
...
export function generateEnvironmentCode(
  environmentType: EnvironmentType,
  platform: "android" | "ios" = "android"
): EnvironmentCodeResult | null {
  if (platform === "ios") {
...
export function formatEnvironmentCode(result: EnvironmentCodeResult): string {
