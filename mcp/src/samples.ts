...
export const SAMPLES: Record<SampleId, Sample> = {
  "model-viewer": {
    ...
    prompt:
      "Create an Android Compose screen that loads a GLB model and displays it with HDR lighting, orbit camera, and animation playback. Use SceneView `io.github.sceneview:sceneview:3.4.7`.",
    code: `@Composable
fun ModelViewerScreen() {
  ...
  "ar-model-viewer": {
    ...
    prompt:
      "Create an AR screen that detects surfaces and lets the user tap to place a GLB model. Support pinch-to-scale and drag-to-rotate. Use SceneView `io.github.sceneview:arsceneview:3.4.7`.",
    code: `@Composable
fun ARModelViewerScreen() {
  ...
  "ar-augmented-image": {
    ...
    dependency: "io.github.sceneview:arsceneview:3.4.7",
    prompt:
      "Create an AR screen that detects a printed reference image and places a 3D model above it. Use SceneView `io.github.sceneview:arsceneview:3.4.7`.",
    code: `@Composable
fun AugmentedImageScreen() {
  ...
  "ar-cloud-anchor": {
    ...
    dependency: "io.github.sceneview:arsceneview:3.4.7",
    prompt:
      "Create an AR screen that can host a cloud anchor (saving its ID) and resolve it later on another device. Use SceneView `io.github.sceneview:arsceneview:3.4.7`.",
    code: `@Composable
fun CloudAnchorScreen() {
  ...
  "ar-point-cloud": {
    ...
    dependency: "io.github.sceneview:arsceneview:3.4.7",
    prompt:
      "Create an AR screen that visualizes ARCore feature points as small 3D spheres, filtered by confidence. Use SceneView `io.github.sceneview:arsceneview:3.4.7`.",
    code: `@Composable
fun PointCloudScreen() {
  ...
  "ar-face-mesh": {
    ...
    dependency: "io.github.sceneview:arsceneview:3.4.7",
    prompt:
      "Create an AR screen that uses the front camera to detect faces and overlay a 3D mesh on them. Use SceneView `io.github.sceneview:arsceneview:3.4.7`.",
    code: `@Composable
fun ARFaceMeshScreen() {
  ...
  "gltf-camera": {
    ...
    dependency: "io.github.sceneview:sceneview:3.4.7",
    prompt:
      "Create a 3D scene that loads a GLB file containing embedded camera definitions, then uses those cameras for cinematic viewpoints. Use SceneView `io.github.sceneview:sceneview:3.4.7`.",
    code: `@Composable
fun GltfCameraScreen() {
  ...
  "camera-manipulator": {
    ...
    dependency: "io.github.sceneview:sceneview:3.4.7",
    prompt:
      "Create a 3D scene with a fully configurable orbit camera — drag to rotate, two-finger pan, pinch to zoom. Use SceneView `io.github.sceneview:sceneview:3.4.7`.",
    code: `@Composable
fun CameraManipulatorScreen() {
  ...
  "camera-animation": {
    ...
    dependency: "io.github.sceneview:sceneview:3.4.7",
    prompt:
      "Create a 3D scene with a camera that automatically orbits around a model in a smooth circle. Include a play/pause button. Use SceneView `io.github.sceneview:sceneview:3.4.7`.",
    code: `@Composable
fun CameraAnimationScreen() {
  ...
  "autopilot-demo": {
    ...
    dependency: "io.github.sceneview:sceneview:3.4.7",
    prompt:
      "Create a Tesla FSD-style autopilot visualization with a 3D car on a road, traffic lights, and a HUD overlay showing speed, distance, and status. Use SceneView `io.github.sceneview:sceneview:3.4.7`.",
    code: `@Composable
fun AutopilotScreen() {
    val engine = rememberEngine()
    val modelLoader = rememberModelLoader(engine)
  ...
  "physics-demo": {
    ...
    dependency: "io.github.sceneview:sceneview:3.4.7",
    prompt:
      "Create a 3D scene where tapping spawns coloured spheres that fall under gravity and bounce off a floor. Add a bounciness slider. Use SceneView `io.github.sceneview:sceneview:3.4.7`.",
    code: `@Composable
fun PhysicsDemoScreen() {
  ...
  "dynamic-sky": {
    ...
    dependency: "io.github.sceneview:sceneview:3.4.7",
    prompt:
      "Create a 3D scene with a time-of-day sun that moves from sunrise through noon to sunset, with atmospheric fog. Use SceneView `io.github.sceneview:sceneview:3.4.7`.",
    code: `@Composable
fun DynamicSkyScreen() {
  ...
  "line-path": {
    ...
    dependency: "io.github.sceneview:sceneview:3.4.7",
    prompt:
      "Create a 3D scene that draws animated parametric curves (sine wave, Lissajous) using PathNode with amplitude and frequency sliders. Use SceneView `io.github.sceneview:sceneview:3.4.7`.",
    code: `@Composable
fun LinePathScreen() {
    val engine = rememberEngine()
    val materialLoader = rememberMaterialLoader(engine)
  ...
  "text-labels": {
    ...
    dependency: "io.github.sceneview:sceneview:3.4.7",
    prompt:
      "Create a 3D scene with floating text labels that always face the camera. Labels show planet names and can be tapped to cycle display modes. Use SceneView `io.github.sceneview:sceneview:3.4.7`.",
    code: `@Composable
fun TextLabelsScreen() {
  ...
  "reflection-probe": {
    ...
    dependency: "io.github.sceneview:sceneview:3.4.7",
    prompt:
      "Create a 3D scene with a metallic sphere and a ReflectionProbeNode that overrides the IBL. Add a material picker to switch between Chrome, Gold, Copper, and Rough. Use SceneView `io.github.sceneview:sceneview:3.4.7`.",
    code: `@Composable
fun ReflectionProbeScreen() {
  ...
  "post-processing": {
    ...
    dependency: "io.github.sceneview:sceneview:3.4.7",
    prompt:
      "Create a 3D scene with interactive post-processing controls for bloom, vignette, tone mapping, FXAA, and SSAO. Use SceneView `io.github.sceneview:sceneview:3.4.7`.",
    code: `@Composable
fun PostProcessingScreen() {
  ...
  "video-texture": {
    ...
    dependency: "io.github.sceneview:sceneview:3.4.7",
    prompt:
      "Create a 3D scene with a video playing on a floating 3D plane. Include play/pause controls and chroma-key support. Use SceneView `io.github.sceneview:sceneview:3.4.7`.",
    code: `@Composable
fun VideoTextureScreen() {
  ...
  "multi-model-scene": {
    ...
    dependency: "io.github.sceneview:sceneview:3.4.7",
    prompt:
      "Create a 3D scene that loads multiple GLB models (a car, a building, and trees) and positions them to form a street scene. Use SceneView `io.github.sceneview:sceneview:3.4.7`.",
    code: `@Composable
fun MultiModelScreen() {
  ...
  "gesture-interaction": {
    ...
    dependency: "io.github.sceneview:sceneview:3.4.7",
    prompt:
      "Create a 3D scene with a model that responds to tap (select), double-tap (scale up), long-press (show info), and supports pinch-to-scale and drag-to-move. Use SceneView `io.github.sceneview:sceneview:3.4.7`.",
    code: `@Composable
fun GestureInteractionScreen() {
  ...
  "environment-lighting": {
    ...
    dependency: "io.github.sceneview:sceneview:3.4.7",
    prompt:
      "Create a 3D scene with full HDR environment lighting (IBL + skybox), a directional sun light, a red point light, and a blue spot light. Use SceneView `io.github.sceneview:sceneview:3.4.7`.",
    code: `@Composable
fun EnvironmentLightingScreen() {
  ...
  "procedural-geometry": {
    ...
    dependency: "io.github.sceneview:sceneview:3.4.7",
    prompt:
      "Create a 3D scene showing procedural geometry shapes (cube, sphere, cylinder, plane) with different PBR materials. No model files needed. Use SceneView `io.github.sceneview:sceneview:3.4.7`.",
    code: `@Composable
fun ProceduralGeometryScreen() {
  ...
  "compose-ui-3d": {
    ...
    dependency: "io.github.sceneview:sceneview:3.4.7",
    prompt:
      "Create a 3D scene with interactive Compose UI elements (Card with text and a button) floating in 3D space using ViewNode. Use SceneView `io.github.sceneview:sceneview:3.4.7`.",
    code: `@Composable
fun ComposeUI3DScreen() {
  ...
  "node-hierarchy": {
    ...
    dependency: "io.github.sceneview:sceneview:3.4.7",
    prompt:
      "Create a 3D solar system where planets orbit a sun using parent-child node hierarchies. Each planet group rotates independently. Use SceneView `io.github.sceneview:sceneview:3.4.7`.",
    code: `@Composable
...
struct VideoPlayerScreen: View {
  ...
  "ios-dynamic-sky": {
    id: "ios-dynamic-sky",
    title: "iOS Dynamic Sky",
    description:
      "Time-of-day sun simulation with DynamicSkyNode — sunrise, noon, sunset, and night presets with interactive slider.",
    tags: ["3d", "lighting", "sky", "ios", "swift"],
    dependency: "https://github.com/sceneview/sceneview — from: \"3.4.7\"",
    spmDependency: "https://github.com/sceneview/sceneview",
    prompt:
      "Create a SwiftUI 3D scene with a dynamic sky that changes lighting based on time of day using a slider. Use SceneViewSwift.",
    language: "swift",
    code: `import SwiftUI
import SceneViewSwift
import RealityKit

struct DynamicSkyScreen: View {
    ...
    var body: some View {
        VStack {
            SceneView { root in
                // Ground plane
                let floor = GeometryNode.plane(
                    width: 5.0, depth: 5.0, color: .lightGray
                )
                root.addChild(floor.entity)

                // Sphere to observe lighting changes
                let sphere = GeometryNode.sphere(
                    radius: 0.4,
                    material: .pbr(color: .white, metallic: 0.5, roughness: 0.3)
                )
                .position(.init(x: 0, y: 0.4, z: 0))
                .withGroundingShadow()
                root.addChild(sphere.entity)

                // Dynamic sky light driven by timeOfDay
            ...
            // Time-of-day slider
            VStack {
                Text(skyLabel(for: timeOfDay))
                    .font(.headline)
                Slider(value: $timeOfDay, in: 0...24, step: 0.5)
                    .padding(.horizontal)
            }
            .padding()
        }
    ...
    func skyLabel(for hour: Float) -> String {
        switch hour {
        case 0..<6: return "Night (\\(Int(hour)):00)"
        case 6..<8: return "Sunrise (\\(Int(hour)):00)"
        case 8..<16: return "Day (\\(Int(hour)):00)"
        case 16..<18: return "Sunset (\\(Int(hour)):00)"
        default: return "Night (\\(Int(hour)):00)"
        }
    }
}`,
  },
  ...
  "ios-line-path": {
    id: "ios-line-path",
    title: "iOS Lines and Paths",
    description:
      "Draw line segments and polyline paths in 3D space using LineNode and PathNode.",
    tags: ["3d", "lines", "geometry", "ios", "swift"],
    dependency: "https://github.com/sceneview/sceneview — from: \"3.4.7\"",
    spmDependency: "https://github.com/sceneview/sceneview",
    prompt:
      "Create a SwiftUI 3D scene with line segments and a closed polygon path in 3D space. Use SceneViewSwift.",
    language: "swift",
    code: `import SwiftUI
import SceneViewSwift
import RealityKit

struct LinePathScreen: View {
    var body: some View {
        SceneView { root in
            // Single line segment
            let line = LineNode(
                from: .init(x: -1.0, y: 0, z: 0),
                to: .init(x: 1.0, y: 0.5, z: -0.5),
                thickness: 0.008,
                color: .red
            )
            ...
            // Open helix path
            var helixPoints: [SIMD3<Float>] = []
            for i in 0..<60 {
                let t = Float(i) * 0.1
                let x = 0.3 * cos(t)
                let y = t * 0.05
                let z = 0.3 * sin(t) - 1.0
                helixPoints.append(.init(x: x, y: y, z: z))
            }
            let helix = PathNode(
                points: helixPoints,
                closed: false,
