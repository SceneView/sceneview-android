...
<div class="sv-stat">
<span class="sv-stat-number">v3.4.7</span>
...
=== "Kotlin (Android)"
    ...
    ```kotlin
    // build.gradle: implementation("io.github.sceneview:sceneview:3.4.7")
...
=== "Swift (iOS / macOS / visionOS)"
    ...
    ```swift
    // Package.swift: .package(url: "https://github.com/sceneview/sceneview-swift", from: "3.4.7")
...
=== "iOS / macOS / visionOS"
    ...
    .package(url: "https://github.com/sceneview/sceneview-swift", from: "3.4.7")
    ```
