...
!!! info "v3.5.1 is production-ready today"
...
!!! note "iOS, macOS, visionOS already available"
    SceneViewSwift v3.5.1 (alpha) ships today with RealityKit rendering.
    v4.0 focuses on Android XR, cross-framework bridges, and deeper KMP integration.

| Platform | Composable | Renderer | Status |
|---|---|---|---|
| Android | `Scene { }` | Filament (OpenGL ES / Vulkan) | Stable (v3.5.1) |
| iOS / macOS / visionOS | `SceneView { }` (SwiftUI) | RealityKit (Metal) | Alpha (v3.5.1) |
