...
|---|---|---|---|---|
| **Android** | Filament | Jetpack Compose | `sceneview` / `arsceneview` | Stable (v3.4.7) |
| **iOS** | RealityKit | SwiftUI | `SceneViewSwift` | Alpha (v3.4.7) |
| **macOS** | RealityKit | SwiftUI | `SceneViewSwift` | Alpha (v3.4.7) |
| **visionOS** | RealityKit | SwiftUI | `SceneViewSwift` | Alpha (v3.4.7) |
