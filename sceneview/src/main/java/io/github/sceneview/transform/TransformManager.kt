package io.github.sceneview.transform
 ...
 */
fun TransformManager.getTransform(@EntityInstance transformInstance: Int) =
    FloatArray(16).apply {
...
fun TransformManager.setTransform(
    @EntityInstance transformInstance: Int,
 ...
 * @see TransformManager.setTransform
 */
fun TransformManager.getWorldTransform(@EntityInstance transformInstance: Int) =
    FloatArray(16).apply {
        getWorldTransform(transformInstance, this)
    }.toTransform()

/**
 * Returns the actual parent entity of an [EntityInstance] originally defined
 * by [TransformManager.setParent].
 *
 ...
 */
@Entity
fun TransformManager.getParentOrNull(@EntityInstance transformInstance: Int): Int? =
 ...
 */
@Entity
fun TransformManager.getChildren(@EntityInstance transformInstance: Int): List<Int> =
 ...
 */
@Entity
fun TransformManager.getAllChildren(@EntityInstance transformInstance: Int): List<Int> {
