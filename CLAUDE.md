...
- 🟢 **MCP GATEWAY #1 IS LIVE (Stripe production mode)** — see `.claude/NOTICE-2026-04-11-mcp-gateway-live.md`. 4 products, 4 `price_1TL6...` LIVE ids, webhook `we_REDACTED_GW1`, all 4 plans return `cs_live_...`. **Pending: first real paying customer.** Do NOT bump `@latest` to 4.x until at least one real checkout succeeds.
